    ...
    <Container className="py-16">
      <div className="space-y-8">
        ...
        <div className="space-y-4">
          <h2 className="text-2xl font-semibold">Devices & Setup</h2>
          <p className="text-muted-foreground text-sm">
            As an Amazon Associate, I earn from qualifying purchases. These
            links help support my work at no extra cost to you.
          </p>
