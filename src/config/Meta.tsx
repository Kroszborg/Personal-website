...
export const siteConfig = {
  ...
  title: 'Abhiman Panwar',
  description:
    'Full Stack Developer specializing in React, Next.js, TypeScript, and 3D web experiences with Three.js',
  ...
  author: {
    ...
    twitter: '@kroszborgg',
    github: 'Kroszborg',
    linkedin: 'abhiman-panwar-272aa7228',
